...
class Yolo(object):
    def __init__(self):
        if pyyolo is not None:
            darknet_path = '/home/lme/pyyolo/darknet'
            datacfg = 'cfg/coco.data'
            cfgfile = 'cfg/yolov1.cfg'  # change it from yolo.cfg to yolov1.cfg
            weightfile = 'yolo.weights'     # change from yolo.weights to tiny-yolo.weights
